...
<head>
  ...
  <title>DOECode Types API Documentation</title>
  ...
  <script>
    ...
    // });
    Flatdoc.run({
      fetcher: Flatdoc.github('doecode/server', 'src/main/java/gov/osti/services/Types.md' )
    });
  </script>
</head>
<body role='flatdoc'>
  ...
  <div class='header'>
    <div class='left'>
      <h1>DOECode Types Services API</h1>
      <ul>
