...
<html>
     <head>
          ...
          <title>DOE CODE User Services API Documentation</title>
          ...
          <!-- Meta -->
          <meta content="DOE CODE User Services API" property="og:title">
          <meta content="Back-end services for DOE CODE application." name="description">

          <!-- Initializer -->
          <script>
              Flatdoc.run({
                 fetcher: Flatdoc.file('${pageContext.request.contextPath}/markdown/UserServices.md')
              });
          </script>
     </head>
     <body role='flatdoc'>
